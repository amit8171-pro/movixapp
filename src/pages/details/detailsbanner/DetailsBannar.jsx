...
import Circlereating from "../../../components/circlereating/Circlereating";
...
export default function DetailsBannar({video, crew}) {
              ...
              <>
                ...
                <ContentWrapper>
                    <div className="content">
                        <div className="left">
                            {data.poster_path ? (
                                <Lazyimg className="posterImg" src={url.backdrop + data.poster_path}/>
                            ) : (
                    ...
                    <VideoPupUp show={show} setShow={setShow} videoId={videoId} setVideoId={setVideoId}/>
                </ContentWrapper>
                    </React.Fragment>
                )}
              </>
