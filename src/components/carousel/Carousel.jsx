...
import Circlereating from "../circlereating/Circlereating";
...
export default function Carousel({data, loading, endpoints, title}) {
                ...
                <div className="carouselItems" ref={carouselContent}>
                  {data?.map((item)=>{
                    ...
                    return(
                        ...
                        onClick={()=> navigate(`/${item.media_type || endpoints}/${item.id}`)}>
                        <div className="posterBlock">
                        <Lazyimg src={posterUrl}/>
                        <Circlereating rating={item.vote_average.toFixed(1)}/>
